...
def update_region_gate(
    ...
    *,
    ...
    Implements a hysteretic rule: gate off when LP is below a threshold and
    stochasticity is high for K consecutive refreshes; re-enable after meeting
    the stronger hysteresis criterion.
