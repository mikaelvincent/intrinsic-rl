"""Common layers and builders for model MLPs."""
...
class FlattenObs(nn.Module):
    """Flatten last dimensions into a single feature axis."""
...
def mlp(
    ...
    """Simple MLP with ReLU activations and an optional output layer.

    The first layer includes FlattenObs to handle [T, B, D] and [B, D] inputs.
    """
