...
\end{equation}
For efficiency, these global medians may be cached and refreshed periodically rather than recomputed on every transition.
...
In experiments we fix $h=2.0$ (Table~\ref{tab:glpe_hparams}).
