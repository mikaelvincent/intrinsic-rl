...
We train the policy using an on-policy actor--critic method with clipped policy updates and generalized advantage estimation (PPO with GAE; details in Section~\ref{sec:experimental_setup}), using the augmented reward $r_t$ for advantage estimation and policy/value updates.
